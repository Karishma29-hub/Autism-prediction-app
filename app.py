...
st.write(f"Your app generated: {input_df.shape[1]} features")
st.write("Columns generated by app:", list(input_df.columns))

if "ID" in input_df.columns:
    input_df = input_df.drop("ID", axis=1)

input_df = input_df.drop(columns=["ID", "result"], errors="ignore")
